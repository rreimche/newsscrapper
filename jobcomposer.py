...
parser.add_argument("file", help="Filename to parse for headlines", type=str)
...
for row in rows:
    ...
    for i in range(3):
        job = "python scrapper.py " + args.database + " " + news_id + str(i) + " " + encoded_query + " limit " + str(args.limit) + "\n"
        jobs.write(job)
